...
public class SelectionSort_2511532016 {
	public static void SelectionSort_2016(int[] arr_2016) {
		...
		for(int i_2016=0; i_2016<n_2016; i_2016++) {
			...
			for(int j_2016=i_2016+1; j_2016<n_2016; j_2016++) {
				if(arr_2016[j_2016] < arr_2016[minIndex_2016]) {
					minIndex_2016 = j_2016;
				}
			}
			int temp_2016 = arr_2016[i_2016];
			arr_2016[i_2016]= arr_2016[minIndex_2016];
			arr_2016[minIndex_2016] = temp_2016;
		}
	}
